	...
	'targets': [
		{
			...
			'sources': [
                ...
                'src/rs/rsvm.h',
                'src/rs/rsvm.cc',
                'src/rs/interface/event_target.h',
                'src/rs/interface/event_target.cc',
                'src/rs/interface/window.h',
                'src/rs/interface/window.cc',
		...
		{
			'target_name': 'action_after_build_01',
			'type': 'none',
		...
		{
            'target_name': 'action_after_build_02',
            'type': 'none',
            'dependencies': [ 'isolated_rsvm' ],
            'copies': [ {
                'files': [ '<(PRODUCT_DIR)/isolated_rsvm.node' ],
