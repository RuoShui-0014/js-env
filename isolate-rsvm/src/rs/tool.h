...
inline Local<String> v8_str(const char* str) {
  return v8_unmaybe(String::NewFromOneByte(Isolate::GetCurrent(),
                                           (const uint8_t*)str,
                                           v8::NewStringType::kInternalized));
}
inline Local<String> v8_str(Isolate* isolate, const char* str) {
  return v8_unmaybe(String::NewFromOneByte(isolate, (const uint8_t*)str,
                                           v8::NewStringType::kInternalized));
}

inline void v8_set_property(Local<Object> target,
                            Local<Name> property,
                            Local<Value> value) {
...
inline void v8_set_property(Local<ObjectTemplate> target,
                            Local<Name> property,
                            Local<Data> value,
...
// CONFIGS(ary)
#define CONFIGS(instance) \
  Configs(instance, sizeof(instance) / sizeof(decltype(instance[0])))
...
inline Local<FunctionTemplate> v8_function(
    v8::FunctionCallback callback = nullptr,
    const char* name = "",
    int length = 0,
    bool isConstruct = false);

inline Local<FunctionTemplate> v8_getter(
    const char* name = "",
    v8::FunctionCallback callback = nullptr,
    Local<Signature> signature = Local<Signature>());
inline Local<FunctionTemplate> v8_setter(
    const char* name = "",
    v8::FunctionCallback callback = nullptr,
    Local<Signature> signature = Local<Signature>());
inline Local<FunctionTemplate> v8_operation(
    const char* name = "",
    int lenght = 0,
    v8::FunctionCallback callback = nullptr,
    Local<Signature> signature = Local<Signature>());
