...
class ReferenceData {
 ...
 public:
  ...
  ReferenceData(std::shared_ptr<IsolateHolder> isolate,
...
class ReferenceHandle : public TransferableHandle,
 ...
 public:
  ...
  template <class... Args>
  explicit ReferenceHandle(Args&&... args)
      : ReferenceData{std::forward<Args>(args)...} {}

  static auto Definition() -> v8::Local<v8::FunctionTemplate>;
  static auto New(v8::Local<v8::Value> value,
                  v8::MaybeLocal<v8::Object> options)
  ...
  auto DerefInto(v8::MaybeLocal<v8::Object> maybe_options)
      -> v8::Local<v8::Value>;
  auto Release() -> v8::Local<v8::Value>;
  auto TypeOfGetter() -> v8::Local<v8::Value>;

  template <int async>
  auto Apply(v8::MaybeLocal<v8::Value> recv_handle,
             v8::Maybe<ArrayRange> maybe_arguments,
             v8::MaybeLocal<v8::Object> maybe_options) -> v8::Local<v8::Value>;

  template <int async>
  auto Copy() -> v8::Local<v8::Value>;

  template <int async>
  auto Get(v8::Local<v8::Value> key_handle,
           v8::MaybeLocal<v8::Object> maybe_options) -> v8::Local<v8::Value>;
  ...
  template <int async>
  auto Set(v8::Local<v8::Value> key_handle,
...
class ReferenceHandleTransferable : public Transferable,
 ...
 public:
  template <class... Args>
  explicit ReferenceHandleTransferable(Args&&... args)
      : ReferenceData{std::forward<Args>(args)...} {}
