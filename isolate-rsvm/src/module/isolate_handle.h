...
class IsolateHandle : public TransferableHandle {
 ...
 public:
  ...
  static auto New(v8::MaybeLocal<v8::Object> maybe_options)
      -> std::unique_ptr<ClassHandle>;
  auto TransferOut() -> std::unique_ptr<Transferable> final;

  template <int async>
  auto CreateContext(v8::MaybeLocal<v8::Object> maybe_options)
      -> v8::Local<v8::Value>;
  template <int async>
  auto CompileScript(v8::Local<v8::String> code_handle,
                     v8::MaybeLocal<v8::Object> maybe_options)
      -> v8::Local<v8::Value>;
  template <int async>
  auto CompileModule(v8::Local<v8::String> code_handle,
                     v8::MaybeLocal<v8::Object> maybe_options)
      -> v8::Local<v8::Value>;
  ...
  template <int async>
  auto GetHeapStatistics() -> v8::Local<v8::Value>;
  ...
  template <int async>
  auto StopCpuProfiler(v8::Local<v8::String> title) -> v8::Local<v8::Value>;

  auto GetReferenceCount() -> v8::Local<v8::Value>;
  auto IsDisposedGetter() -> v8::Local<v8::Value>;
  static auto CreateSnapshot(ArrayRange script_handles,
                             v8::MaybeLocal<v8::String> warmup_handle)
      -> v8::Local<v8::Value>;
};
