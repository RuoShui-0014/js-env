...
struct ModuleInfo {
  // Underlying data on the module. Some information is stored outside of v8 so
  // there is a separate struct to hold this data, which is then referenced by
...
class ModuleHandle : public TransferableHandle {
 ...
 public:
  ...
  auto Instantiate(class ContextHandle& context_handle,
                   v8::Local<v8::Function> callback) -> v8::Local<v8::Value>;
  auto InstantiateSync(class ContextHandle& context_handle,
                       v8::Local<v8::Function> callback)
      -> v8::Local<v8::Value>;

  template <int async>
  auto Evaluate(v8::MaybeLocal<v8::Object> maybe_options)
      -> v8::Local<v8::Value>;
