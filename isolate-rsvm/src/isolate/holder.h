...
class IsolateHolder {
 ...
 public:
  ...
  void ScheduleTask(std::unique_ptr<Runnable> task,
                    bool run_inline,
                    bool wake_isolate,
...
// This needs to be separate from IsolateHolder because v8 holds references to
// this indefinitely and we don't want it keeping the isolate alive.
