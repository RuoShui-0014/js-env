...
/**
 * This handles communication to the v8 backend. There is only one of these per
 * isolate, but many sessions may connect to this agent.
 *
 * This class combines the role of both V8Inspector and V8InspectorClient into a
 * single class.
 */
class InspectorAgent : public v8_inspector::V8InspectorClient {
 ...
 private:
  ...
  auto ConnectSession(InspectorSession& session)
...
/**
 * Individual session to the v8 inspector agent. This probably relays messages
 * from a websocket to the v8 backend. To use the class you need to implement
 * the abstract methods defined in Channel.
 *
 * This class combines the role of both V8Inspector::Channel and
 * V8InspectorSession into a single class.
 */
