...
template <class Type>
struct DontFreezePrototype<Type, typename Type::DontFreezePrototype>
    : std::true_type {};
...
template <class Type>
struct DontFreezeInstance<Type, typename Type::DontFreezeInstance>
    : std::true_type {};

}  // namespace detail

/**
 * Analogous to node::ObjectWrap but Isolate-aware. Also has a bunch of
 * unnecessary template stuff.
 */
class ClassHandle {
  template <class Signature>
 ...
 private:
  ...
  struct TemplateDefinition {
    ...
    void Add(const char* name,
             detail::MemberFunctionHolder impl,
             Args... args) {
      v8::Local<v8::String> name_handle = v8_symbol(name);
      proto->Set(name_handle, v8::FunctionTemplate::New(isolate, impl.callback,
                                                        {}, sig, impl.length));
      Add(args...);
    }
    ...
    void Add(const char* name, detail::FreeFunctionHolder impl, Args... args) {
      v8::Local<v8::String> name_handle = v8_symbol(name);
      tmpl->Set(name_handle, v8::FunctionTemplate::New(
                                 isolate, impl.callback, {},
                                 v8::Local<v8::Signature>(), impl.length));
      Add(args...);
    }
    ...
    template <typename... Args>
    void Add(const char* name,
             detail::MemberAccessorHolder impl,
             Args... args) {
      v8::Local<v8::String> name_handle = v8_symbol(name);
      proto->SetAccessor(name_handle, impl.getter.callback,
                         impl.setter.callback);
      Add(args...);
    }
    ...
    template <typename... Args>
    void Add(const char* name,
             detail::StaticAccessorHolder impl,
             Args... args) {
      v8::Local<v8::String> name_handle = v8_symbol(name);
      v8::Local<v8::FunctionTemplate> setter;
      if (impl.setter.callback != nullptr) {
        setter = v8::FunctionTemplate::New(isolate, impl.setter.callback,
                                           name_handle);
      }
      tmpl->SetAccessorProperty(
          name_handle,
          v8::FunctionTemplate::New(isolate, impl.getter.callback, {}), setter);
      Add(args...);
    }
  ...
  /**
   * Convenience wrapper for the obtuse SetWeak function signature. When the
   * callback is called the handle will already be gone.
   */
   ...
   */
  static void Wrap(std::unique_ptr<ClassHandle> ptr,
  ...
  /**
   * It just throws when you call it; used when `nullptr` is passed as
   * constructor
   */
  static void PrivateConstructor(
      const v8::FunctionCallbackInfo<v8::Value>& info) {
    throw RuntimeTypeError(detail::CalleeName(info) +
 ...
 protected:
   ...
   */
  template <typename... Args>
  static auto MakeClass(const char* class_name,
                        detail::ConstructorFunctionHolder New,
                        Args... args) -> v8::Local<v8::FunctionTemplate> {
   ...
   */
  template <typename T>
  static auto Inherit(v8::Local<v8::FunctionTemplate> definition)
 ...
 public:
  ...
  /**
   * Freeze the handle and prototype unless `DontFreezeInstance` is set on the
   * class handle
   */
  template <class Type>
  static auto MaybeFreeze(v8::Local<v8::Object> handle) {
    ...
    if (!detail::DontFreezePrototype<Type>::value) {
      handle->GetPrototype().As<v8::Object>()->SetIntegrityLevel(
          context, v8::IntegrityLevel::kFrozen);
    }
  ...
  static auto NewInstance(Args&&... args) -> v8::Local<v8::Object> {
    ...
    v8::Local<v8::Object> instance = Unmaybe(
        GetFunctionTemplate<T>()->InstanceTemplate()->NewInstance(context));
  ...
  static auto Unwrap(v8::Local<v8::Object> handle) -> T* {
    ...
    return dynamic_cast<T*>(static_cast<ClassHandle*>(
...
template <class Type>
inline auto HandleCastImpl(v8::Local<v8::Value> value,
                           const HandleCastArguments& /*arguments*/,
                           HandleCastTag<Type&> /*tag*/) -> Type& {
  if (!value->IsObject()) {
...
template <class Signature>
struct ConstructorFunctionImpl<Signature*>
    : ConstructorFunctionImpl<Signature> {};

template <class Return, class... Args>
struct ConstructorFunctionImpl<Return(Args...)> {
  using Type = v8::Local<v8::Value> (*)(v8::Local<v8::Value> This,
                                        Args... args);

  template <Return (*Function)(Args...)>
  static inline auto Invoke(v8::Local<v8::Value> This, Args... args)
      -> v8::Local<v8::Value> {
    auto instance = Function(args...);
    if (instance) {
      v8::Local<v8::Object> handle = This.As<v8::Object>();
      ClassHandle::MaybeFreeze<typename decltype(instance)::element_type>(
          handle);
...
struct ConstructorFunction : detail::ConstructorFunctionHolder {
  ...
  ConstructorFunction()
      : ConstructorFunctionHolder{
            Entry, std::tuple_size<typename detail::extract_arguments<
                       Signature>::arguments>::value} {}
  ...
  static void Entry(const v8::FunctionCallbackInfo<v8::Value>& info) {
    detail::RunBarrier([&]() {
      ...
      ToCallback<-1, typename Impl::Type, &Impl::template Invoke<Function>>()(
          info);
    });
  }
